...
/**
 * @brief UhdRead::UhdRead
 * @param rate
 * @param freq
 * @param gain
 * @param frameSize
 *
 * Initialize the uhd, creating a USRP object to communicate with the usrp.
 */
...
/**
 * @brief UhdRead::setThreadPrioritySafe
 *
 * Set the thread priority to safe, statically defined.
 */
 ...
 * @param frameSize
 *
 * Performes the initialization of the usrp object, taking the rate, center frequency, gain and frame size.
 */
